...
const reclamos = [
  ...
  { id: '12', fecha: 'Marzo / 2026',     registros: 2, valor: '$1.500.000', estado: 'Pagado',       documentacion: 'Pendiente'       },
...
const titulares = [
  ...
  // --- TITULARES DE RECLAMOS CON DOCUMENTOS PENDIENTES ---
  {
    nombre: 'Carlos Ruiz Mendoza',
    tipoDoc: 'Cédula de Ciudadanía',
    numDoc: '1098765432',
    telefono: '314 872 3301',
    correo: 'cruizmendoza@correo.com',
    direccion: 'Calle 34 #18-22',
    ciudad: 'Bogotá',
    valorDesembolsado: 4200000,
    fechaDesembolso: 'Marzo / 2026',
    comisionPagada: 105000,
    cargueId: '07',
    cargueFecha: 'Marzo / 2026',
    numPagare: '2210',
    reclamos: [{ reclamoId: '14', valor: 4200000, tipo: 'Total', estado: 'Reclamo radicado' }],
    documentos: 'pendiente'
  },
  {
    ...
    tipoDoc: 'Cédula de Ciudadanía',
    numDoc: '1087654321',
    telefono: '301 445 6678',
    correo: 'lfospina@correo.com',
    direccion: 'Carrera 11 #52-80, Apto 201',
    ciudad: 'Medellín',
    valorDesembolsado: 3800000,
    fechaDesembolso: 'Febrero / 2026',
    comisionPagada: 95000,
    cargueId: '07',
    cargueFecha: 'Marzo / 2026',
    numPagare: '2211',
    reclamos: [{ reclamoId: '14', valor: 3800000, tipo: 'Total', estado: 'Reclamo radicado' }],
    documentos: 'pendiente'
  },
  {
    nombre: 'Mario Alberto Vásquez',
    tipoDoc: 'Cédula de Ciudadanía',
    numDoc: '1076543210',
    telefono: '320 119 5542',
    correo: 'mavasquez@correo.com',
    direccion: 'Av. 30 de Agosto #40-15',
    ciudad: 'Pereira',
    valorDesembolsado: 2900000,
    fechaDesembolso: 'Enero / 2026',
    comisionPagada: 72500,
    cargueId: '07',
    cargueFecha: 'Marzo / 2026',
    numPagare: '2212',
    reclamos: [{ reclamoId: '14', valor: 2900000, tipo: 'Total', estado: 'Reclamo radicado' }],
    documentos: 'pendiente'
  },
  {
    ...
    tipoDoc: 'Cédula de Ciudadanía',
    numDoc: '1065432109',
    telefono: '316 234 7890',
    correo: 'amlopez@correo.com',
    direccion: 'Cra. 7 #65-43',
    ciudad: 'Cali',
    valorDesembolsado: 5100000,
    fechaDesembolso: 'Diciembre / 2025',
    comisionPagada: 127500,
    cargueId: '06',
    cargueFecha: 'Febrero / 2026',
    numPagare: '2205',
    reclamos: [{ reclamoId: '13', valor: 5100000, tipo: 'Total', estado: 'En proceso' }],
    documentos: 'pendiente'
  },
  {
    nombre: 'Héctor Javier Reyes',
    tipoDoc: 'Cédula de Ciudadanía',
    numDoc: '1054321098',
    telefono: '313 901 2234',
    correo: 'hjreyes@correo.com',
    direccion: 'Calle 80 #9-55, Casa 3',
    ciudad: 'Bucaramanga',
    valorDesembolsado: 3300000,
    fechaDesembolso: 'Noviembre / 2025',
    comisionPagada: 82500,
    cargueId: '06',
    cargueFecha: 'Febrero / 2026',
    numPagare: '2206',
    reclamos: [{ reclamoId: '13', valor: 3300000, tipo: 'Total', estado: 'En proceso' }],
    documentos: 'pendiente'
  },
  {
    ...
    tipoDoc: 'Cédula de Ciudadanía',
    numDoc: '1043210987',
    telefono: '318 667 4421',
    correo: 'smcardenas@correo.com',
    direccion: 'Transv. 18 #22-60',
    ciudad: 'Manizales',
    valorDesembolsado: 2600000,
    fechaDesembolso: 'Octubre / 2025',
    comisionPagada: 65000,
    cargueId: '06',
    cargueFecha: 'Febrero / 2026',
    numPagare: '2207',
    reclamos: [{ reclamoId: '13', valor: 2600000, tipo: 'Total', estado: 'En proceso' }],
    documentos: 'pendiente'
  },
  {
    nombre: 'Rodrigo Andrés Morales',
    tipoDoc: 'Cédula de Ciudadanía',
    numDoc: '1032109876',
    telefono: '311 334 8890',
    correo: 'ramorales@correo.com',
    direccion: 'Calle 15 #31-72, Apto 502',
    ciudad: 'Barranquilla',
    valorDesembolsado: 4700000,
    fechaDesembolso: 'Septiembre / 2025',
    comisionPagada: 117500,
    cargueId: '06',
    cargueFecha: 'Febrero / 2026',
    numPagare: '2208',
    reclamos: [{ reclamoId: '13', valor: 4700000, tipo: 'Total', estado: 'En proceso' }],
    documentos: 'pendiente'
  },
  {
    nombre: 'Patricia Isabel Gómez',
    tipoDoc: 'Cédula de Ciudadanía',
    numDoc: '1021098765',
    telefono: '300 778 1123',
    correo: 'pigomez@correo.com',
    direccion: 'Carrera 43A #19-30',
    ciudad: 'Cali',
    valorDesembolsado: 3100000,
    fechaDesembolso: 'Agosto / 2025',
    comisionPagada: 77500,
    cargueId: '06',
    cargueFecha: 'Febrero / 2026',
    numPagare: '2209',
    reclamos: [{ reclamoId: '13', valor: 3100000, tipo: 'Total', estado: 'En proceso' }],
    documentos: 'pendiente'
  }
];
